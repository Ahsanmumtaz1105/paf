...
cur_dir = os.getcwd().split('libs')[0]
root_path = os.path.join(cur_dir, 'docs')
...
def get_only_py_files(file_path):
    if 'utils' in file_path:
        folder_path = [_f for _f in os.listdir(file_path) if os.path.isfile(_f)]
    else:
        folder_path = [_f for _f in os.listdir(file_path) if
                       not os.path.isfile(_f)]
    only_py_files = []
...
def doc_generator():
    ...
    for _fol in get_folder(cur_dir):
        doc_path = create_folder(root_path + '\{}'.format(_fol))
        ...
        if fol:
            for sub_fol in fol:
                ...
                fol_doc_path = create_folder(root_path + r'\{}\{}'.
                                             format(_fol, sub_fol))
                ...
                if fol2:
                    for sub_fol2 in fol2:
                        fol_doc_path2 = create_folder(root_path + '\{}\{}\{}'.
                                                      format(_fol, sub_fol,
                                                             sub_fol2))
                        ...
                        if fol3:
                            for sub_fol3 in fol3:
                                fol_doc_path3 = create_folder(
                                    root_path + '\{}\{}\{}\{}'.
                                    format(_fol, sub_fol, sub_fol2, sub_fol3))
                                sub_path3 = os.path.join(sub_path2, sub_fol3)
                                py_files3 = get_only_py_files(sub_path3)
                                for l in py_files3:
                                    fol_temp_doc_path3 = os.path.join(
                                        fol_doc_path3, l)
                                    cmd = "python -m robot.libdoc -f html " \
                                          "{}.{}.{}.{}.{} {}.html"
                                    os.system(cmd.format(_fol, sub_fol,
                                                         sub_fol2, sub_fol3, l,
                                                         fol_temp_doc_path3))
